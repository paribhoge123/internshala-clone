    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">{t("resume.subtitle")}</p>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="A motivated student seeking an internship..."
                />
              </div>
              ...
              >
                {isLoading ? "Sending OTP..." : t("resume.continue")}
              </button>
            </form>
          </div>
        )}
        ...
        {step === "otp" && (
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            >
              ...
              >
                {isLoading ? "Verifying..." : t("resume.verifyotp")}
              </button>
              <button
                type="button"
